...
public class ActionListener implements WebDriverListener {
  ...
  private List<WebElement> getOrigins(Sequence sequence) {
    ...
    if (!encodedSequence.containsKey("com/otus/actions")) {
      return Collections.emptyList();
    }
    return ((List<Map<String, Object>>) encodedSequence.get("com/otus/actions")).stream()
